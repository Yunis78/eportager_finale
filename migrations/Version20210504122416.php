 ...
 */
final class Version20210504122416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, producer_id INT DEFAULT NULL, user_id INT DEFAULT NULL, status VARCHAR(20) NOT NULL, message LONGTEXT NOT NULL, rate INT NOT NULL, INDEX IDX_9474526C89B658FE (producer_id), INDEX IDX_9474526CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE media (id INT AUTO_INCREMENT NOT NULL, producer_id INT DEFAULT NULL, product_id INT DEFAULT NULL, categorie_id INT DEFAULT NULL, path VARCHAR(255) NOT NULL, INDEX IDX_6A2CA10C89B658FE (producer_id), INDEX IDX_6A2CA10C4584665A (product_id), INDEX IDX_6A2CA10CBCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media DROP FOREIGN KEY FK_6A2CA10C89B658FE');
